<%-- 
    Document   : 35-RegistrationList
    Created on : Oct 2, 2021, 5:48:45 PM
...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Show the list of users' registrations">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>35 Registrations List</title>
    <link rel="stylesheet" href="css/nicepage.css" media="screen">
<link rel="stylesheet" href="css/35-Registrations-List.css" media="screen">
    ...
    <meta property="og:title" content="35 Registrations List">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-496a">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-subtitle u-text u-text-default u-text-1"> Show the list of users' registrations</h2>
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <input type="hidden" id="siteId" name="siteId" value="268966958">
            <input type="hidden" id="pageId" name="pageId" value="245429608">
            <div class="u-form-group u-form-partition-factor-4 u-form-select u-form-group-1">
              <label for="select-bd01" class="u-label">Subject (searchable)</label>
              <div class="u-form-select-wrapper">
                <select id="select-bd01" name="select" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                  <option value="SWP391">SWP391</option>
                </select>
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" version="1" class="u-caret"><path fill="currentColor" d="M4 8L0 4h8z"></path></svg>
              </div>
            </div>
            <div class="u-form-date u-form-group u-form-partition-factor-4 u-form-group-2">
              <label for="date-94a4" class="u-label">Registration time</label>
              <input type="date" placeholder="MM/DD/YYYY" id="date-94a4" name="date" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-group u-form-partition-factor-4 u-form-select u-form-group-3">
              <label for="select-26b5" class="u-label">Status</label>
              <div class="u-form-select-wrapper">
                <select id="select-26b5" name="select-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
            ...
            <div class="u-form-email u-form-group u-form-partition-factor-4 u-form-group-4">
              <label for="email-dc51" class="u-label">Search by email</label>
              <input type="email" placeholder="Enter a valid email address" id="email-dc51" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-align-left u-form-group u-form-submit">
              <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-palette-4-base u-btn-1">Submit filter</a>
        ...
        <p class="u-text u-text-default u-text-2">You can sort elements by click at the header of each column</p>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-palette-4-base u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Registration time</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Subject</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Package</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Total cost</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Valid from</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Valid to</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Last edit by</th>
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Edit</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
              <tr style="height: 75px;">
                <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-11">1</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">abc@gmail.com</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">14/9/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">SWP391</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">19$</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">19$</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">20/9/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">11/11/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">Dr Dre</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell u-table-cell-20"></td>
              </tr>
              <tr style="height: 76px;">
                <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-21">2</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">123@gmail.com</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">10/9/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">SWP391</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">25$</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">25$</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">15/9/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">12/11/2021</td>
                <td class="u-border-1 u-border-grey-30 u-table-cell">Dr Dre</td>
