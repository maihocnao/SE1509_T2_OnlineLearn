...
<html style="font-size: 16px;">
  <head>
    ...
    <title>3 Reset password</title>
    <link rel="stylesheet" href="css/nicepage.css" media="screen">
<link rel="stylesheet" href="css/3-Reset-password.css" media="screen">
    ...
    <meta property="og:title" content="3 Reset password">
    <meta property="og:type" content="website">
  </head>
  <body class="u-body u-palette-1-base"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" data-image-width="1280" data-image-height="853" id="sec-508c">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h3 class="u-text u-text-1">Reset password</h3>
        <p class="u-text u-text-2">Please input your email, we will sent you new password</p>
        <div class="u-form u-form-1">
          <form action="resetPass" method="get" class="u-clearfix u-form-custom-backend u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px" source="custom">
            <div class="u-form-email u-form-group">
              <label for="email-14cf" class="u-form-control-hidden u-label u-label-1">Name</label>
              <input type="email" placeholder="Email" id="email-14cf" name="email" class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white u-input-1" required="">
            </div>
