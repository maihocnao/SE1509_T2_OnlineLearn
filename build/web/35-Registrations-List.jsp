<%-- 
    Document   : 35-Registrations-List
    Created on : Oct 2, 2021, 9:49:51 PM
    Author     : asus
--%>
...
<!DOCTYPE html>
<%
    ArrayList<Registration> rlist = (ArrayList<Registration>) request.getAttribute("rlist");
%>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-palette-4-base u-table-header u-table-header-1">
              <tr style="height: 21px;">
                ...
                <th class="u-border-1 u-border-palette-4-base u-table-cell">Package ID</th>
            ...
            <tbody class="u-table-body">
              ...
              <tr style="height: 75px;">
                <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-11"><%= r.getRegistrationID() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getUserEmail() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getRegisTime() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getSubjectID() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getPricePackageID() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getTotalPrice() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getValidFrom() %></td>
                <td class="u-border-1 u-border-grey-30 u-table-cell"><%= r.getValidto() %></td>
