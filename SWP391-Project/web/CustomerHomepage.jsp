...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="css/CustomerCSS.css" media="screen">
<link rel="stylesheet" href="css/CustomerHome.css" media="screen">
    <script class="u-script" type="text/javascript" src="js/Customerjquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="js/CustomerJS.js" defer=""></script>
