...
<%@page import="bean.*" %>
<%
    ArrayList<PricePackage> pplist = (ArrayList<PricePackage>) request.getAttribute("pplist");
%>
...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Find your smartness">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>11 Course Details</title>
    <link rel="stylesheet" href="css/nicepage.css" media="screen">
<link rel="stylesheet" href="css/11-Course-Details.css" media="screen">
    ...
    <meta property="og:title" content="11 Course Details">
  ...
  <body class="u-body">
      <header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="homepageservlet" style="padding: 10px 20px;">Homepage</a>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="homepageservlet" style="padding: 10px 20px;">Homepage</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="user/RegistUser.jsp">Sign up</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-sidenav-overflow">
                <div class="u-menu-close"></div>
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Login.jsp">Login</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="user/RegistUser.jsp">Sign up</a>
</li></ul>
              </div>
            </div>
    ...
    <section class="u-align-left u-clearfix u-image u-shading u-section-1" src="${subject.thumbnail}" data-image-width="512" data-image-height="178" id="sec-fe21">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h1 class="u-text u-text-default u-title u-text-1">${subject.name}</h1>
        <p class="u-large-text u-text u-text-variant u-text-2">${subject.description}</p>
        <a href="#" class="u-border-none u-btn u-button-style u-palette-4-base u-btn-1">Go to course</a>
      </div>
    </section>
    <section class="u-align-center u-clearfix u-grey-5 u-section-2" id="sec-036d">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-clearfix u-gutter-20 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <%for(PricePackage pp: pplist){%>  
              <div class="u-align-center u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-container-style u-layout-cell u-left-cell u-size-15 u-size-30-md u-white u-layout-cell-1">
                <div class="u-container-layout u-valign-top u-container-layout-1">
                  <h5 class="u-text u-text-1"><%= pp.getPPname() %></h5>
                  <h3 class="u-text u-text-2">$<%= pp.getSalePrice() %></h3>
                  <p class="u-text u-text-3"><%= pp.getAccessDuration() %> Days</p>
                  <a href="CourseRegisterController?subjectid=${subject.subjectID}&pricepackageid=<%= pp.getPricePackageID() %>" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-4-base u-radius-50 u-btn-1">Order Now</a>
                </div>
              </div>
              <%}%>
            </div>
