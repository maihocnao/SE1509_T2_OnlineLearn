<%-- 
    Document   : LessonView
    Created on : Oct 13, 2021, 2:45:04 AM
    Author     : Mai
--%>
...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="css/CusCss.css" media="screen">

    <script class="u-script" type="text/javascript" src="js/Cusjquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="js/CusJS.js" defer=""></script>
  ...
  <body class="u-body">    
      <header class="u-clearfix u-header u-palette-4-base u-header" id="sec-5ca7"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a href="homepageservlet" class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px 20px;">Homepage</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="bloglist" style="padding: 10px 20px;">Blogs</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"  href="courseListController" style="padding: 10px 20px;">Browse Courses</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="MyCourseController" style="padding: 10px 20px;">My Registrations</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2"><li class="u-nav-item"><a href="homepageservlet" class="u-button-style u-nav-link" style="padding: 10px 20px;">Homepage</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="bloglist" style="padding: 10px 20px;">Blogs</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link"  href="courseListController" style="padding: 10px 20px;">Browse Courses</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="MyCourseController" style="padding: 10px 20px;">My Registrations</a>
</li></ul>
              </div>
            </div>
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-2">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Your-Profile.html">Your Profile</a>
</li><li class="u-nav-item"><a  class="u-button-style u-nav-link" href="LogoutController">Log out</a>
</li></ul>
          </div>
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
    ...
    <section class="u-clearfix u-section-1" id="sec-a676">
    ...
    <iframe class="iframeVideo" src="${yt}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
  
    <!--<iframe class="iframeVideo"  width="1100" height="570" style="line-height:0" src="https://www.youtube.com/embed/hZTehTRzY50" title="YouTube video player" 
          frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
   
    
    
  <c:set var ="countRow" scope="page" value="1"></c:set>
      <div class="box">
          <h2 style="margin-bottom: 5px;">Course Content </h2>
          <ul>
          <c:forEach var="lesson" items="${lessonList}" >
              <li><span><c:out value="${countRow}"></c:out></span><a href="LessonViewController?lessonID=${lesson.lessonID}">${lesson.lessonName}</a></li>
              <c:set var="countRow" scope="page" value="${countRow+1}"></c:set>
          </c:forEach>
