<%-- 
    Document   : SaleHomepage
    Created on : Sep 24, 2021, 11:45:38 AM
...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="nicepageSale.css" media="screen">
<link rel="stylesheet" href="SaleHomepage.css" media="screen">
    <script class="u-script" type="text/javascript" src="jquery.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="nicepageSale.js" defer=""></script>
