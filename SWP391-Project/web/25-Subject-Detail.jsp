...
<html style="font-size: 16px;">
  <head>
    ...
    <title>25 Subject Detail</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="25-Subject-Detail.css" media="screen">
    ...
    <meta property="og:title" content="25 Subject Detail">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-palette-4-light-3 u-section-1" id="sec-4b0e">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-tabs u-tabs-1">
          <ul class="u-tab-list u-unstyled" role="tablist">
            <li class="u-tab-item" role="presentation">
              <a class="active u-active-palette-4-base u-button-style u-hover-palette-4-light-2 u-palette-4-light-2 u-tab-link u-text-body-alt-color u-tab-link-1" id="link-tab-0da5" href="#tab-0da5" role="tab" aria-controls="tab-0da5" aria-selected="true">Overview</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-4-base u-button-style u-hover-palette-4-light-2 u-palette-4-light-2 u-tab-link u-text-body-alt-color u-tab-link-2" id="link-tab-14b7" href="#tab-14b7" role="tab" aria-controls="tab-14b7" aria-selected="false">Dimension</a>
            </li>
            <li class="u-tab-item" role="presentation">
              <a class="u-active-palette-4-base u-button-style u-hover-palette-4-light-2 u-palette-4-light-2 u-tab-link u-text-body-alt-color u-tab-link-3" id="link-tab-2917" href="#tab-2917" role="tab" aria-controls="tab-2917" aria-selected="false">Price Package</a>
            </li>
          </ul>
          <div class="u-tab-content">
            <div class="u-container-style u-tab-active u-tab-pane u-white u-tab-pane-1" id="tab-0da5" role="tabpanel" aria-labelledby="link-tab-0da5">
              <div class="u-container-layout u-valign-bottom u-container-layout-1">
                <img class="u-image u-image-default u-image-1" src="images/f814e757e81643899e2471a8466fa2e9da3aa470d242dec7a15acaa67c3385291d4fb7dc4fd100dffc8b5d76059e11d27b9e8cf3c2ac4b281acd0e_1280.jpg" alt="" data-image-width="1280" data-image-height="853">
                <div class="u-form u-form-1">
                  <form action="#" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
                    <div class="u-form-group u-form-name">
                      <label for="name-98a3" class="u-form-control-hidden u-label"></label>
                      Subject ID: <input type="text" placeholder="Subject ID" id="name-98a3" name="subjectid" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                    </div>
                    <div class="u-form-group u-form-name">
                      <label for="name-98a3" class="u-form-control-hidden u-label"></label>
                      Subject Name: <input type="text" placeholder="Subject Name" id="name-98a3" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                    </div>
                    <div class="u-form-group u-form-name">
                      <label for="name-98a3" class="u-form-control-hidden u-label"></label>
                      Thumbnail: <input type="file" accept="image/*" name="thumbnail">
                    </div>
                    <div class="u-form-group u-form-select u-form-group-2">
                      <label for="select-1bb4" class="u-form-control-hidden u-label"></label>
                      <div class="u-form-select-wrapper">
                        Dimension: <select id="select-1bb4" name="categoryid" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                    ...
                    <div class="u-form-group u-form-select u-form-group-3">
                      <label for="select-4199" class="u-form-control-hidden u-label"></label>
                      <div class="u-form-select-wrapper">
                        Status: <select id="select-4199" name="status" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                    ...
                    <div class="u-form-checkbox u-form-group u-form-group-4">
                      <input type="checkbox" id="checkbox-cb8a" name="featured" value="On" required="required">
                      <label for="checkbox-cb8a" class="u-label">Featured</label>
                    </div>
                    <div class="u-form-group u-form-textarea u-form-group-5">
                      <label for="textarea-a5fa" class="u-form-control-hidden u-label"></label>
                      Description: <textarea rows="4" cols="50" id="textarea-a5fa" name="description" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" placeholder="Description"></textarea>
                    </div>
                ...
                <a href="https://nicepage.com/k/apple-website-templates" class="u-border-none u-btn u-button-style u-hover-palette-1-light-1 u-palette-4-base u-btn-2">Back</a>
              </div>
            </div>
            <div class="u-container-style u-tab-pane u-white u-tab-pane-2" id="tab-14b7" role="tabpanel" aria-labelledby="link-tab-14b7">
              <div class="u-container-layout u-valign-top u-container-layout-2">
                <p class="u-text u-text-1">Sample text. Click to select the text box. Click again or double click to start editing the text. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.<br>
            ...
            <div class="u-container-style u-tab-pane u-white u-tab-pane-3" id="tab-2917" role="tabpanel" aria-labelledby="link-tab-2917">
              <div class="u-container-layout u-container-layout-3">
                <h4 class="u-text u-text-default u-text-2">Be The First To Review This Product!</h4>
                ...
                <a href="" class="u-btn u-button-style u-btn-3">write product review</a>
              </div>
            </div>
          </div>
        </div>
