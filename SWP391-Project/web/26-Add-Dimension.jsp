<%-- 
    Document   : 26-Add-Dimension
    Created on : Oct 9, 2021, 8:59:45 PM
    Author     : asus
--%>
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-193e">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-subtitle u-text u-text-default u-text-1">Add Subject Dimension</h2>
        <div class="u-form u-form-1">
          <form action="AddDimensionController" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-select u-form-group-2">
              <label for="select-5f25" class="u-form-control-hidden u-label"></label>
              Dimension Name: <input type="text" value="" id="name-6058" name="categoryname" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
            <div class="u-form-group u-form-select u-form-group-3">
              <label for="select-be07" class="u-form-control-hidden u-label"></label>
              Dimension Type: <input type="text" value="" id="name-6058" name="type" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
