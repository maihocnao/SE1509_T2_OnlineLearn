<%-- 
    Document   : 36-Registration-Details
    Created on : Oct 2, 2021, 8:49:39 PM
    Author     : Phong
--%>
...
<html style="font-size: 16px;">
    <head>
        ...
        <meta charset="utf-8">
        <meta name="keywords" content="Registration Information">
        <meta name="description" content="">
        <meta name="page_type" content="np-template-header-footer-from-plugin">
        <title>36 Registration Details</title>
        <link rel="stylesheet" href="css/nicepage.css" media="screen">
        <link rel="stylesheet" href="css/36-Registration-Details.css" media="screen">
        ...
        <meta property="og:title" content="36 Registration Details">
    ...
    <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <section class="u-clearfix u-section-1" id="sec-e3a2">
            <div class="u-clearfix u-sheet u-sheet-1">
                <h2 class="u-subtitle u-text u-text-default u-text-1">Registration Information</h2>
            </div>
        </section>
        <section class="u-align-center u-clearfix u-section-2" id="sec-299a">
            <div class="u-clearfix u-sheet u-sheet-1">
                    ...
                    <table class="u-table-entity u-table-entity-1">
                        ...
                        <tbody class="u-table-body">
                                ...
                                <tr style="height: 75px;">
                                    <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-3">Subject</td>             
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.subject.name}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-5">List Price</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.pricePackage.listPrice}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-7">Full Name</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.user.fullname}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-first-column u-grey-5 u-table-cell u-table-cell-9">Gender</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.user.gender}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-11">Email</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.user.email}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-13">Mobile</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.user.phone}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-15">Registration time</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.registration.regisTime}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-17">Sale</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.pricePackage.salePrice}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-19">Status</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.registration.status}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-21">Valid from</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.registration.validFrom}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-23">Valid to</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">${regisdetail.registration.validto}</td>
                                </tr>
                                <tr style="height: 76px;">
                                    <td class="u-border-1 u-border-grey-30 u-grey-5 u-table-cell u-table-cell-25">Notes</td>
                                    <td class="u-border-1 u-border-grey-30 u-table-cell">nothing to note</td>
                                </tr>
                ...
                <a href="#" class="u-active-none u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-hover-none u-none u-radius-0 u-btn-1">Change to Paid</a>
                <a href="#" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-4-base u-radius-6 u-btn-2">Save</a>
                <a href="#" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-2-base u-palette-4-base u-radius-6 u-btn-3">Cancel</a>
            </div>
        </section>
