...
<html style="font-size: 16px;">
    ...
    <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <section class="u-clearfix u-section-1" id="sec-955d">
            <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-form u-form-1">
                    <form action="register" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" name="form" style="padding: 10px;">
                        ...
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input type="text" placeholder="Enter your phone number" id="text-19ae" name="phonenumber" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            <label for="text-5226" class="u-label">Address</label>
                            <input type="text" placeholder="Enter your address" id="text-5226" name="address" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        ...
                        <div class="u-form-group u-form-group-6">
                            ...
                            <input type="password" placeholder="Enter your password" id="text-547b" name="password" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div class="u-form-group u-form-group-7">
                            <label for="text-1571" class="u-form-control-hidden u-label"></label>
                            <input type="password" placeholder="Re-enter password" id="text-1571" name="text-3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
        ...
        <c:if test = "${IS_EXISTED  == 'true'}">
            <script type="text/javascript">
                alert("Mail existed, please enter new email");
            </script>
        </c:if>
