<%-- 
    Document   : 26-Subject-Dimensions
    Created on : Oct 7, 2021, 9:23:54 PM
    Author     : asus
--%>
...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Edit Subject Dimension">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>26 Subject Dimensions</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="26-Subject-Dimensions.css" media="screen">
    ...
    <meta property="og:title" content="26 Subject Dimensions">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-193e">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-subtitle u-text u-text-default u-text-1">Edit Subject Dimension</h2>
        <div class="u-form u-form-1">
          <form action="UpdateDimensionController" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 10px;">
            <div class="u-form-group u-form-name u-form-group-1">
              <label for="name-6058" class="u-form-control-hidden u-label"></label>
              Dimension ID: <input type="text" value="<%= c.getCategoryID() %>" id="name-6058" name="categoryid" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" readonly>
            </div>
            <div class="u-form-group u-form-select u-form-group-2">
              <label for="select-5f25" class="u-form-control-hidden u-label"></label>
              Dimension Name: <input type="text" value="<%= c.getCategoryName() %>" id="name-6058" name="categoryname" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
            <div class="u-form-group u-form-select u-form-group-3">
              <label for="select-be07" class="u-form-control-hidden u-label"></label>
              Dimension Type: <input type="text" value="<%= c.getType() %>" id="name-6058" name="type" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
            </div>
