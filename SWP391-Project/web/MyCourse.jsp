    ...
    <body>
     <jsp:include page="header.jsp"></jsp:include>
        ...
        <section class="u-clearfix u-section-1 center" id="sec-955d">
            <h1 style="text-align: center; background: #2cccc4; color: white;"> Welcome back! </h1>
            <br>
                    ...
                    <c:forEach var="item" items="${myCourses}">
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                ${item.description}   <br>
                                <br>
                                <a href="#">  <input style="background-color: #2cccc4;border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block;font-size: 16px;" type="submit" value="Continue" /> </a>
                            </td>
