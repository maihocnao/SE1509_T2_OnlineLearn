<%-- 
    ...
    Created on : Oct 3, 2021, 2:30:10 PM
  ...
  <body class="u-body">
      <header class="u-clearfix u-header u-palette-4-dark-1 u-header" id="sec-af13"><div class="u-clearfix u-sheet u-sheet-1">
...
</li><li class="u-nav-item"><a href="SubjectListController" class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px;">Subjects List</a>
...
</li><li class="u-nav-item"><a href="admin/list-user" class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" style="padding: 10px;">Users List</a>
...
</li><li class="u-nav-item"><a href="SubjectListController" style="padding: 10px;">Subjects List</a>
        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-2">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-nav u-unstyled u-nav-3"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="UserDetailsController">Your Profile</a>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                <div class="u-menu-close"></div>
                <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-4"><li class="u-nav-item"><a class="u-button-style u-nav-link" href="UserDetailsController">Your Profile</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Log-out.html">Log out</a>
</li></ul>
              </div>
            </div>
    ...
    <section class="listSetting">
            <h2 class="stTittle">Admin Setting List</h2>
            <div class="box left">
                <ul>
                    <li><a>User Roles</a></li>
                    <li><a>Post Categories</a></li>
                    <li><a>Test Types</a></li>
                    <li><a>Lesson Types</a></li>
                </ul>
            </div>
            <div class="box right">
                <ul>
                    <li><a href="#">System Menu</a></li>
                    <li><a href="#">Subject Categories</a></li>
                    <li><a href="#">Question Levels</a></li>
                    <li><a href="#">Subject Dimension</a></li>
                </ul>
            </div>
        </section>
